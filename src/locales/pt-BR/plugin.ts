export default {
  ...
  'plugin.aigenerate.demand.description': 'É possível definir requisitos unificados para todos os artigos escritos sobre IA, com no máximo 200 caracteres. Deixe em branco por padrão',
  ...
  'plugin.aigenerate.source.description': 'Declaração: Somente sites estrangeiros criados com Anqi CMS podem optar por preparar seu próprio OpenAIKey.',
  'plugin.aigenerate.source.check-openai': 'Verifique a interface OpenAI',
  'plugin.aigenerate.openai.description': 'OpenAI Key geralmente começa com sk-, você pode adicionar várias chaves e o programa selecionará aleatoriamente uma chave para usar de cada vez.',
  ...
  'plugin.aigenerate.default-category.description': 'Se as palavras-chave não forem classificadas em categorias, os artigos coletados serão classificados aleatoriamente em uma das categorias por padrão. Você deve definir uma categoria, caso contrário, os artigos coletados não poderão ser coletados normalmente.',
  ...
  'plugin.aigenerate.start-time.description': 'Preencha um número de 0 a 23, 0 significa que não há limite',
  'plugin.aigenerate.end-time': 'fim do dia',
  'plugin.aigenerate.end-time.placeholder': 'Termina às 22h por padrão',
  'plugin.aigenerate.end-time.description': 'Preencha um número de 0 a 23, 0 significa que não há limite',
  'plugin.aigenerate.daily-limit': 'Lançamentos diários',
  'plugin.aigenerate.daily-limit.description': 'O número máximo de artigos publicados por dia, 0 significa sem limite',
  ...
  'plugin.aigenerate.replace.tips1': 'Edite os pares de palavras-chave que precisam ser substituídos e a substituição será realizada automaticamente quando o documento for publicado.',
  'plugin.aigenerate.replace.tips2': 'As regras de substituição suportam expressões regulares Se você estiver familiarizado com expressões regulares e não conseguir atender aos requisitos de substituição por meio de texto comum, poderá tentar usar regras de expressões regulares para concluir a substituição.',
  'plugin.aigenerate.replace.tips3': 'As regras de expressão regular são: comece com { e termine com } e escreva o código da regra no meio, como {[0-9]+} para corresponder a números consecutivos.',
  'plugin.aigenerate.replace.rules': 'Algumas regras integradas podem ser usadas rapidamente. As internas são:',
  ...
  'plugin.aigenerate.replace.notice': 'Nota: A escrita inadequada de regras de expressão regular pode facilmente levar a efeitos de substituição incorretos. Por exemplo, as regras de ID do WeChat afetarão a integridade dos endereços de e-mail e URLs. Por favor, use com cuidado.',
  ...
  'plugin.aigenerate.tips1': 'A escrita automática de IA chamará a interface de escrita de IA para escrever, o que requer pagamento.',
  'plugin.aigenerate.tips2': 'A escrita automática de IA chamará automaticamente palavras-chave na biblioteca de palavras-chave para concluir a escrita e escreverá um artigo para cada palavra-chave. Certifique-se de que o número de artigos no banco de dados de palavras-chave seja suficiente.',
  'plugin.aigenerate.tips3': 'As funções de escrita automática e coleta de artigos por IA compartilham uma biblioteca de palavras-chave. Se as palavras-chave foram coletadas para artigos, elas não serão mais usadas para escrita por IA.',
  'plugin.aigenerate.tips4': 'Os artigos gerados entrarão automaticamente no gerenciamento de conteúdo.',
  ...
  'plugin.anchor.link.description': 'Suporta links relativos e links absolutos, como: /a/123.html ou https://www.anqicms.com/',
  'plugin.anchor.weight': 'Peso do texto âncora',
  'plugin.anchor.weight.description': 'Insira um número, de 0 a 9. Quanto maior o número, maior será o peso. Os pesos mais altos terão prioridade na substituição.',
  'plugin.anchor.import': 'Importar texto âncora',
  'plugin.anchor.import.description': 'Nota: Somente arquivos no formato csv são suportados para upload e importação.',
  ...
  'plugin.anchor.density.description': 'Por exemplo: a cada 100 palavras para substituir um texto âncora, preencha 100, o padrão é 100',
  ...
  'plugin.anchor.extract.description': 'Escolha como extrair palavras-chave do texto âncora das tags de palavras-chave do conteúdo',
  ...
  'plugin.backup.restore.content': 'Após a restauração, os dados existentes serão substituídos pelos dados de backup atuais. Por favor, proceda com cautela.',
  ...
  'plugin.backup.cleanup.tips1': 'Esta operação excluirá todos os artigos. Por razões de segurança, certifique-se de realizar primeiro um backup em caso de circunstâncias imprevistas.',
  'plugin.backup.cleanup.tips2': 'A pasta Uploads não é limpa por padrão. Se precisar limpá-la, verifique.',
  ...
  'plugin.backup.tips': 'Nota: Se o arquivo de backup for muito grande e você precisar baixá-lo, use ferramentas FTP para baixar o arquivo de backup. O arquivo de backup está no diretório /data/backup/ do diretório raiz do site.',
  ...
  'plugin.collector.mode.description': 'O modo de coleta de artigos coletará o artigo inteiro de acordo com o texto original. O modo de combinação de perguntas e respostas irá coletar e combiná-lo em artigos da lista de perguntas e respostas de pesquisa.',
  'plugin.collector.source': 'fontes personalizadas',
  'plugin.collector.source.description': 'A coleção de artigos está disponível. Observe que o formato de origem personalizado deve ser uma lista de pesquisa e as palavras-chave de pesquisa são representadas por %s. Por exemplo, o link de pesquisa é: https://cn.bing.com/search?q=. Anqi CMS, então " "Anqi CMS" é substituído por "%s" e depois: https://cn.bing.com/search?q=%s',
  'plugin.collector.category.description': 'Se nenhuma categoria for definida para a palavra-chave, os artigos coletados serão classificados nesta categoria por padrão.',
  'plugin.collector.category.notice': 'Uma categoria deve ser definida, caso contrário a coleta normal não será possível',
  ...
  'plugin.collector.min-title.description': 'Ao coletar artigos, se o número de palavras do título for menor que o número de palavras especificado, ele não será coletado.',
  ...
  'plugin.collector.min-content.description': 'Ao coletar artigos, se o número de palavras no conteúdo do artigo for menor que o número especificado de palavras, ele não será coletado.',
  ...
  'plugin.collector.pseudo.description': 'A reescrita de IA oferece suporte apenas à coleta de artigos e combinações de perguntas e respostas. É necessária uma taxa.',
  'plugin.collector.translate': 'Quer traduzir',
  'plugin.collector.translate.no': 'não',
  'plugin.collector.translate.yes': 'Traduzir',
  'plugin.collector.translate.description': 'Há uma taxa para tradução. Nota: A reescrita e a tradução da IA ​​não podem ser habilitadas ao mesmo tempo, caso contrário os resultados estarão errados.',
  ...
  'plugin.collector.daily-limit.description': 'O número máximo de artigos coletados por dia, 0 significa sem limite',
  ...
  'plugin.collector.title-exclude.tips': 'Ao coletar artigos, se essas palavras-chave aparecerem no título, elas não serão coletadas.',
  'plugin.collector.title-prefix': 'Exclua palavras no início do título',
  'plugin.collector.title-prefix.tips': 'Ao coletar artigos, se essas palavras-chave aparecerem no início do título, elas não serão coletadas.',
  'plugin.collector.title-suffix': 'Excluir palavras no final do título',
  'plugin.collector.title-suffix.tips': 'Ao coletar artigos, se essas palavras-chave aparecerem no final do título, elas não serão coletadas.',
  'plugin.collector.content-exclude-line': 'linha de ignorar conteúdo',
  'plugin.collector.content-exclude-line.tips': 'Ao coletar artigos, as linhas em que essas palavras aparecem serão removidas.',
  'plugin.collector.content-exclude': 'Exclusão de conteúdo',
  'plugin.collector.content-exclude.tips': 'Ao coletar artigos, caso essas palavras apareçam no conteúdo, todo o artigo será descartado.',
  'plugin.collector.link-exclude': 'Link ignorado',
  'plugin.collector.link-exclude.tips': 'Ao coletar artigos, caso essas palavras-chave apareçam no link, elas não serão coletadas.',
  ...
  'plugin.collector.start.content': 'Isso iniciará imediatamente a execução de uma operação de tarefa de coleta',
  'plugin.collector.tips': 'Para coletar artigos, você precisa primeiro definir as palavras-chave principais. Verifique a função "Gerenciamento de banco de dados de palavras-chave" e adicione as palavras-chave correspondentes.',
  ...
  'plugin.fileupload.upload.support': 'Nota: Somente arquivos de verificação no formato txt/htm/html/xml podem ser carregados.',
  ...
  'plugin.finance.withdraw.confirm.content': 'Isso equivale apenas a solicitar a retirada do lado do usuário.',
  ...
  'plugin.finance.withdraw.finish.confirm': 'Tem certeza de que deseja concluir o saque manualmente?',
  'plugin.finance.withdraw.finish.content': 'Se você pagou ao usuário offline, pode clicar aqui para concluí-lo.',
  ...
  'plugin.fulltext.tips': 'Depois de ativar a pesquisa de texto completo, você poderá pesquisar o conteúdo do documento. No entanto, a pesquisa de texto completo ocupará muita memória do servidor. Se o seu servidor tiver pouca memória, não é recomendado ativar a pesquisa de texto completo.',
  ...
  'plugin.group.level.description': 'Por exemplo, os membros ordinários são de nível 0, os membros intermediários são de nível 1, os membros seniores são de nível 2, os membros principais são de nível 3, etc.',
  'plugin.group.price': 'Preço do grupo de usuários',
  'plugin.group.price.suffix': 'apontar',
  'plugin.group.price.description': 'O preço que precisa ser pago para adquirir o VIP deste grupo de usuários. Observe que a unidade é centavos. Por exemplo, 1 yuan, preencha 100 aqui.',
  'plugin.group.expire_day': 'Período de validade do grupo de usuários',
  'plugin.group.expire_day.suffix': 'céu',
  'plugin.group.expire_day.description': 'Após adquirir o VIP, ele será válido por quantos dias. Preencha 365 por 1 ano. Após o vencimento, ele retornará ao primeiro grupo de usuários.',
  'plugin.group.share_reward': 'Período de validade do grupo de usuários',
  'plugin.group.share_reward.description': 'Recomenda-se definir 5%-20 e o ponto decimal não pode ser definido. Prioridade do índice de comissão: Índice de comissão definido por produto > Índice de comissão do grupo de usuários > Índice de comissão padrão',
  'plugin.group.parent_reward': 'Proporção de recompensa por convite',
  'plugin.group.parent_reward.description': 'Recomenda-se definir 1%-5% e o ponto decimal não pode ser definido. Taxa de comissão superior. O distribuidor a convida b para se tornar um distribuidor e b se torna o próximo vendedor de a. Quando b promove um pedido com sucesso, b pode receber comissão de distribuição e a recebe apenas a recompensa do convite.',
  'plugin.group.discount': 'Desconto para usuários',
  'plugin.group.discount.description': 'Recomenda-se definir 90% -100%. Após o usuário acessar a página através do link compartilhado pelo distribuidor, ele poderá aproveitar o desconto ao fazer um pedido.',
  ...
  'plugin.guestbook.reply.required': 'Configure primeiro o lembrete por e-mail e pesquise "Lembrete por e-mail" na função.',
  ...
  'plugin.guestbook.field.delete.confirm.content': 'Você pode restaurar atualizando a página antes de salvar.',
  ...
  'plugin.guestbook.return-message.description': 'O prompt que os usuários veem após enviar uma mensagem. Por exemplo: Obrigado pela sua mensagem!',
  ...
  'plugin.htmlcache.generate.all.confirm': 'Tem certeza de que deseja gerar um cache estático para todo o site?',
  'plugin.htmlcache.generate.home.confirm': 'Tem certeza de que deseja gerar um cache estático da página inicial?',
  'plugin.htmlcache.generate.category.confirm': 'Tem certeza de que deseja gerar um cache estático da coluna?',
  'plugin.htmlcache.generate.archive.confirm': 'Tem certeza de que deseja gerar um cache estático do documento?',
  'plugin.htmlcache.generate.tag.confirm': 'Tem certeza de que deseja gerar um cache estático de tags?',
  'plugin.htmlcache.clean.confirm': 'Tem certeza de que deseja limpar o cache estático de todo o site? Se houver muitos arquivos em cache, pode demorar muito.',
  'plugin.htmlcache.clean.confirm.content': 'Esta operação limpa apenas os arquivos de cache local do servidor e não pode limpar os arquivos estáticos do servidor.',
  'plugin.htmlcache.clean.success': 'Limpeza bem-sucedida',
  'plugin.htmlcache.push.all.confirm': 'Tem certeza de que deseja enviar todos os arquivos estáticos para o servidor estático?',
  'plugin.htmlcache.push.all.confirm.content': 'Ele só está disponível quando um servidor estático é configurado. O push completo leva muito tempo. Se nenhuma alteração global for feita, o push incremental poderá ser usado.',
  'plugin.htmlcache.push.addon.confirm': 'Tem certeza de que deseja enviar arquivos estáticos de forma incremental para o servidor estático?',
  'plugin.htmlcache.push.addon.confirm.content': 'Disponível somente quando um servidor estático é configurado, o push incremental enviará apenas arquivos de cache estático atualizados.',
  ...
  'plugin.htmlcache.index-time.description': 'Se você preencher 0 segundos, ele não será armazenado em cache.',
  ...
  'plugin.htmlcache.aliyun.endpoint.placeholder': 'Por exemplo: http://oss-cn-hangzhou.aliyuncs.com',
  ...
  'plugin.htmlcache.tencent.bucket-url.placeholder': 'Por exemplo: https://aa-1257021234.cos.ap-guangzhou.myqcloud.com',
  ...
  'plugin.htmlcache.upyun.bucket': 'Dê uma olhada também no nome do serviço de armazenamento em nuvem',
  'plugin.htmlcache.ftp.tips': 'Nota: Após o teste, o PureFtp que acompanha o Pagoda não pode ser usado normalmente.',
  ...
  'plugin.htmlcache.ssh.or-key.description': 'Se o seu servidor SSH usa uma chave para fazer login, faça upload dela',
  ...
  'plugin.htmlcache.description.1': 'Depois de ativar o cache de página estática, a página inicial, a página de lista e a página de detalhes serão armazenadas em cache para acelerar a abertura do site, mas será necessário mais espaço no servidor para armazenar os arquivos de cache.',
  'plugin.htmlcache.description.2': 'Se você precisar habilitar um site estático, o tipo de modelo precisará ser adaptável. Para abrir um site estático, você precisa preencher as informações do servidor do site estático. Após a comunicação bem-sucedida, o sistema transmitirá automaticamente a página estática para o servidor do site estático.',
  'plugin.htmlcache.description.3': 'Antes de habilitar um site estático, você precisa habilitar o cache de página estática. Depois de habilitar um site estático, a pesquisa, mensagem, comentário, salto 301 e outras funções que exigem o envio de dados ao backend serão inválidas e o site terá apenas efeitos de exibição.',
  'plugin.htmlcache.description.4': 'Depois de ativar um site estático, as seguintes operações não serão regeneradas automaticamente e as operações de geração de páginas estáticas precisam ser executadas manualmente: Ajustar modelos (modificar modelos, ativar modelos), Modificar configurações de plano de fundo (configurações globais, configurações de conteúdo, informações de contato, navegação , etc.), regras pseudoestáticas modificadas e outras mudanças que afetam a situação global',
  ...
  'plugin.importapi.token.confirm.content': 'Após a atualização, o Token original torna-se inválido, use o novo endereço API para operação.',
  'plugin.importapi.token.copy.success': 'Copiado com sucesso',
  'plugin.importapi.tips': 'O conteúdo gerado por meio de plataformas de terceiros, como escrita de IA, pode ser importado para este sistema via API.',
  ...
  'plugin.importapi.field.url-token': 'Alias ​​de URL personalizado, compatível apenas com números e letras em inglês',
  'plugin.importapi.field.images': 'As imagens do artigo podem ser configuradas em até 9 fotos.',
  'plugin.importapi.field.logo': 'A miniatura do documento pode ser um endereço absoluto, como: https://www.anqicms.com/logo.png ou um endereço relativo, como: /logo.png',
  'plugin.importapi.field.publish-time': 'Formato: 2006-01-02 15:04:05 O prazo de divulgação do documento pode ser no futuro. Se for no futuro, o documento não será divulgado oficialmente até que o prazo acabe.',
  'plugin.importapi.field.tag': 'Tag do documento. Várias tags são separadas por vírgulas em inglês, por exemplo: aaa, bbb, ccc',
  'plugin.importapi.field.diy': 'Outros campos personalizados',
  'plugin.importapi.field.diy.remark': 'Se você passar outros campos personalizados e os campos existirem na tabela do documento, eles também serão suportados.',
  'plugin.importapi.field.draft': 'Se deve ser salvo em rascunho. Os valores suportados são: false|true Quando true for preenchido, o documento publicado será salvo em rascunho.',
  'plugin.importapi.field.cover': 'Se deve substituir documentos com o mesmo título e ID quando existirem. Os valores suportados são: false|true Quando true for preenchido, o conteúdo mais recente será substituído. Quando definido como false, um erro será exibido.',
  ...
  'plugin.importapi.category-api.module-id': 'O ID do modelo da classificação a ser obtida, preencha o número, valores suportados: 0=todos, 1,2...ID do modelo correspondente',
  ...
  'plugin.importapi.train-mopdule.support-version.text': 'Suporte ao coletor de locomotivas versão 9.0 ou superior para importar e usar o módulo de lançamento',
  ...
  'plugin.importapi.token.new.description': 'O token é geralmente composto por uma combinação de números e letras, com mais de 10 dígitos e menos de 128 dígitos.',
  'plugin.interference.isopen': 'Ative a coleta de código anti-interferência',
  'plugin.interference.isopen.description': 'As configurações a seguir só serão efetivas se a função estiver ativada.',
  ...
  'plugin.keyword.batch-import.tips': 'Nota: Somente arquivos no formato csv são suportados para upload e importação.',
  ...
  'plugin.keyword.dig-setting.max-count.description': 'Se a expansão automática de palavras for selecionada, o número de expansões de palavras será válido.',
  ...
  'plugin.keyword.dig-setting.title-exclude.description': 'Ao expandir palavras, se essas palavras-chave aparecerem nas palavras-chave, elas não serão coletadas.',
  'plugin.keyword.dig-setting.replace': 'Substituição de palavra-chave',
  'plugin.keyword.dig-setting.replace.tips1': 'Edite os pares de palavras-chave que precisam ser substituídos e a substituição será realizada automaticamente ao expandir as palavras.',
  'plugin.keyword.delete.confirm': 'Tem certeza de que deseja excluir as palavras-chave selecionadas?',
  ...
  'plugin.keyword.aigenerate.confirm': 'Tem certeza de que deseja realizar operações de gravação de IA nesta palavra-chave?',
  'plugin.keyword.aigenerate.content': 'A escrita automática de IA requer pagamento, certifique-se de vincular sua conta Anqi.',
  'plugin.keyword.aigenerate.doing': 'Gerando',
  'plugin.keyword.cleanup.confirm': 'Tem certeza de que deseja limpar todas as palavras-chave para isso?',
  'plugin.keyword.cleanup.content': 'Esta operação excluirá todas as palavras-chave e não poderá ser recuperada. Por favor, opere com cuidado',
  ...
  'plugin.link.field.nofollow': 'Se deseja adicionar nofollow, valores opcionais: 0 para não adicionar, 1 para adicionar',
  'plugin.link.field.back-link': 'Página do link oposto',
  'plugin.link.field.back-link.description': 'O URL da página onde a outra parte colocou o link para este site',
  'plugin.link.field.self-title': 'minhas palavras-chave',
  'plugin.link.field.self-title.description': 'As palavras-chave que coloquei na página da outra parte',
  ...
  'plugin.link.field.contact.description': 'Preencha QQ, WeChat, número de telefone, etc. para facilitar o contato de acompanhamento',
  ...
  'plugin.material.import.clear': 'Tem certeza de que deseja limpar os materiais de conteúdo selecionados para upload?',
  ...
  'plugin.material.import.submit.tips.after': 'Nenhuma seção foi selecionada para este material. Deseja continuar enviando?',
  ...
  'plugin.material.import.batch-add.tips': 'Nota: Você pode fazer upload de artigos armazenados em txt ou html.',
  ...
  'plugin.material.import.paste.description': 'Por padrão, o conteúdo filtrará todas as tags HTML e reterá apenas o texto. Se você precisar manter tags HTML, verifique',
  ...
  'plugin.order.setting.progress.description': 'As transações normais exigem que o usuário confirme o recebimento ou conclua o pedido após o vencimento. A transação é concluída diretamente após o pagamento do usuário e o pedido é concluído.',
  ...
  'plugin.order.setting.seller-percent.description': 'Porcentagem de receita de vendas do comerciante',
  ...
  'plugin.order.apply-refund.confirm': 'Tem certeza de que deseja solicitar o reembolso deste pedido?',
  'plugin.order.apply-refund.content': 'Após o reembolso, os fundos serão devolvidos à rota original.',
  ...
  'plugin.push.tips': 'A função push do mecanismo de pesquisa suporta push ativo por pesquisa Baidu e pesquisa Bing. Embora outros mecanismos de pesquisa não tenham função push ativa, alguns mecanismos de pesquisa ainda podem usar push JS.',
  ...
  'plugin.push.baidu.api-link.description': 'Por exemplo: http://data.zz.baidu.com/urls?site=https://www.anqicms.com&token=DTHpH8Xn99BrJLBY',
  'plugin.push.bing.api-link.description': 'Por exemplo: http://data.zz.baidu.com/urls?site=https://www.anqicms.com&token=DT Por exemplo: https://ssl.bing.com/webmaster/api.svc/json /SubmitUrlbatch ?apikey=sampleapikeyEDECC1EA4AE341CC8B6 (observe que esta APIkey está definida nas configurações no canto superior direito da ferramenta Bing)',
  'plugin.push.google': 'JSON da chave da conta do Google',
  'plugin.push.google.json': 'Conteúdo JSON',
  'plugin.push.google.description': 'Não disponível no mercado interno. Consulte o documento para obter JSON: https://www.anqicms.com/google-indexing-help.html',
  'plugin.push.other-js': '360/Toutiao e outros JS enviam automaticamente',
  'plugin.push.other-js.add': 'Adicionar código JS',
  'plugin.push.other-js.tips1': 'Você pode colocar códigos JS, como envio automático Baidu JS, inclusão automática 360 e inclusão automática Toutiao.',
  'plugin.push.other-js.tips2': 'Esses códigos precisam ser chamados manualmente no modelo. Por favor, adicione o código `{{- pluginJsCode|safe }}` no final do modelo público para chamar.',
  'plugin.push.other-js.tips3': 'Janelas pop-up, como mensagens/comentários, carregarão automaticamente esses códigos JS.',
  ...
  'plugin.redirect.import.tips': 'Nota: Somente arquivos no formato csv são suportados para upload e importação.',
  ...
  'plugin.redirect.from-url.description': 'Pode ser um endereço absoluto começando com `http(https)` ou um endereço relativo começando com `/`',
  ...
  'plugin.replace.tips': 'A substituição de todo o site é uma operação avançada e podem ocorrer erros de substituição. É recomendável realizar um backup do conteúdo antes da substituição.',
  ...
  'plugin.retailer.allow-self.description': 'Se a comissão de autocompra estiver ativada, o distribuidor poderá obter a comissão correspondente se ele próprio comprar os produtos distribuídos. Se estiver desativada, o distribuidor não poderá obter a comissão se ele próprio comprar os produtos distribuídos. Se você se tornar automaticamente um distribuidor, não habilite a comissão de autocompra.',
  ...
  'plugin.retailer.become-retailer.description': 'Se você escolher o processamento manual, será necessário configurá-lo no gerenciamento de usuários.',
  'plugin.retailer.cancel.confirm': 'Tem certeza de que deseja cancelar a qualificação de distribuidor deste usuário?',
  'plugin.retailer.cancel.content': 'Se o limite do distribuidor for tornar-se automaticamente um distribuidor, o cancelamento será inválido.',
  ...
  'plugin.rewrite.formula5': 'Opção 5: Modo personalizado (modo avançado, use-o com cuidado, se estiver configurado incorretamente, a página inicial não abrirá)',
  ...
  'plugin.rewrite.setting.diy.tips': 'Copie as seguintes regras na caixa de entrada para modificar. Existem 6 linhas no total, ou seja, detalhes do documento, lista de documentos, página inicial do modelo, página, lista de tags e detalhes de tags. === e a parte anterior não pode ser modificada.',
  'plugin.rewrite.variable.tips': 'Variáveis ​​​​são colocadas entre chaves `{}`, como `{id}`. As variáveis ​​​​disponíveis são: ID de dados `{id}`; nome do link personalizado do documento `{filename}`, nome do link personalizado de classificação multinível `{multicatname}`, `{ Apenas um dos multicatname}` e `{catname}` podem ser usados; ID de classificação `{catid}`; nome da tabela do modelo `{module}`; , hora `{hora}`, minuto `{minuto}`, segundo `{segundo}`, ano, mês, dia, hora, minuto e segundo estão disponíveis apenas no arquivo paginação número da página `{page}`, paginação; precisa ser colocado entre parênteses, como: `(/{page})` .',
  ...
  'plugin.robots.tips.before': 'Robôs são a configuração de um site que informa aos spiders dos mecanismos de pesquisa quais páginas podem ser rastreadas e quais não podem ser rastreadas. P:',
  'plugin.robots.tips.after': 'Formato do arquivo robots.txt',
  'plugin.robots.content': 'Conteúdo de robôs',
  'plugin.robots.content.tips1': '1. Robots.txt pode informar ao Baidu quais páginas do seu site podem ser rastreadas e quais páginas não podem ser rastreadas.',
  'plugin.robots.content.tips2': '2. Você pode usar a ferramenta Robots para criar, verificar e atualizar seu arquivo robots.txt.',
  ...
  'plugin.sendmail.port.description': 'A porta padrão do servidor é 25, a porta padrão ao usar o protocolo SSL é 465 e a porta padrão ao usar o protocolo TLS é 587. Peça parâmetros detalhados ao seu provedor de serviços de e-mail.',
  'plugin.sendmail.account': 'Conta SMTP',
  'plugin.sendmail.account.description': 'O padrão é a conta de e-mail, como seu e-mail QQ, como 123456@qq.com',
  'plugin.sendmail.password': 'Senha SMTP',
  'plugin.sendmail.password.description': 'Código de autorização gerado nas configurações de e-mail.',
  'plugin.sendmail.recipient': 'E-mail do destinatário',
  'plugin.sendmail.recipient.required': 'Configure seu e-mail primeiro',
  'plugin.sendmail.recipient.description': 'Por padrão, ele é enviado ao remetente. Se você precisar enviá-lo para outras pessoas, preencha aqui. Use vírgulas para separar vários destinatários.',
  ...
  'plugin.sendmail.auto-reply.description': 'Se a resposta automática aos clientes estiver ativada, quando o cliente deixar uma mensagem, um e-mail de resposta automática será enviado automaticamente para o endereço de e-mail preenchido pelo cliente.',
  ...
  'plugin.sendmail.send-type.description': 'Uma vez selecionado, os e-mails serão enviados no cenário selecionado.',
  ...
  'plugin.sendmail.tips': 'Os lembretes por e-mail podem enviar mensagens do site para sua caixa de correio por e-mail.',
  'plugin.sendmail.test.send': 'Enviar e-mail de teste',
  'plugin.sitemap.tips1': 'Hoje em dia, todos os principais mecanismos de pesquisa oferecem suporte a mapas de sites no formato txt ao enviar mapas de sites, e o tamanho dos arquivos de mapas de sites txt é menor do que os arquivos de mapas de sites xml. Portanto, é recomendado usar mapas de sites no formato txt.',
  'plugin.sitemap.tips2': 'Como o envio de mapa de site de cada mecanismo de pesquisa é limitado a 50.000 itens ou 10 milhões de tamanho, esta função de mapa de site gerará um arquivo de mapa de site com 50.000 itens.',
  ...
  'plugin.sitemap.exculde-module.description': 'Se quiser excluir determinados modelos de documentos, você pode selecioná-los aqui',
  'plugin.sitemap.exculde-category': 'Categorias excluídas',
  'plugin.sitemap.exculde-category.description': 'Se quiser excluir determinadas categorias, você pode escolher aqui',
  'plugin.sitemap.exculde-page': 'Página única excluída',
  'plugin.sitemap.exculde-page.description': 'Se quiser excluir certas páginas únicas, você pode escolher aqui',
  'plugin.sitemap.action': 'operação manual',
  'plugin.sitemap.action.tips': 'Dica: Depois de modificar a configuração do Sitemap, gere-o manualmente para que a configuração entre em vigor.',
  ...
  'plugin.storage.tips': 'A troca de métodos de armazenamento de recursos não sincronizará automaticamente os recursos carregados anteriormente. Geralmente, não é recomendado trocar os métodos de armazenamento durante o uso.',
  ...
  'plugin.storage.keep-local.description': 'Ao usar o armazenamento em nuvem, você pode optar por manter os arquivos locais',
  ...
  'plugin.timefactor.end-day.description': 'Se você preencher 0, significa que será atualizado para o dia atual.',
  'plugin.timefactor.republish': 'Se deve re-empurrar',
  'plugin.timefactor.republish.no': 'não',
  'plugin.timefactor.republish.yes': 'sim',
  'plugin.timefactor.republish.description': 'Ao atualizar o documento, reenvie-o para testar os mecanismos de pesquisa.',
  'plugin.timefactor.release-draft': 'Se deve ativar a publicação automática de documentos de rascunho de caixa',
  ...
  'plugin.timefactor.daily-limit.description': 'Após a configuração, publique um número específico de artigos da caixa de rascunho todos os dias, o padrão é 100',
  ...
  'plugin.timefactor.start-time.description': 'Por exemplo: 8, então todos os dias começam às 8 horas',
  ...
  'plugin.timefactor.category.placeholder': 'Se quiser excluir determinadas categorias, você pode escolher aqui',
  ...
  'plugin.titleimage.open.description': 'Quando habilitado, quando o documento não possui imagem, uma imagem contendo o título do documento será gerada automaticamente como imagem em miniatura do documento.',
  'plugin.titleimage.draw-sub': 'Se deve gerar uma imagem de título secundária para o documento',
  'plugin.titleimage.draw-sub.description': 'Após ligá-lo, quando o documento não possuir imagem, uma imagem será gerada automaticamente para a tag h2 do documento e inserida no documento.',
  'plugin.titleimage.size': 'Gerar tamanho de imagem',
  'plugin.titleimage.width': 'Largura de pixel',
  'plugin.titleimage.width.placeholder': 'Se deve gerar um texto com padrão de 800 títulos secundários e imagens',
  ...
  'plugin.titleimage.bg-image.description': 'Você pode personalizar o plano de fundo. Se não carregar um plano de fundo personalizado, o sistema gerará automaticamente um plano de fundo de cor sólida.',
  ...
  'plugin.transfer.token.required': 'Por favor preencha o Token de comunicação, que pode ser qualquer caractere',
  ...
  'plugin.transfer.tips': 'Atualmente, o conteúdo do site DedeCMS / WordPress / PbootCMS / EmpireCMS tem suporte para migração para anqicms.',
  ...
  'plugin.transfer.step2.tips': 'Faça upload do arquivo baixado para o diretório raiz do seu site. Após baixá-lo e colocá-lo no diretório raiz do seu site, clique em Avançar para continuar.',
  'plugin.transfer.step3.tips': 'Apenas um token pode ser configurado para cada site. Se você receber um erro, exclua manualmente anqicms.config.php no diretório raiz do site para configurá-lo novamente.',
  ...
  'plugin.transfer.step4.tips': 'Por padrão, tudo é migrado. Você pode optar por migrar apenas algumas partes dele.',
  ...
  'plugin.user.password.description': 'Caso necessite alterar a senha deste usuário, preencha-a aqui, com no mínimo 6 caracteres',
  ...
  'plugin.user.expire.description': 'Após a expiração, o grupo de usuários retornará ao primeiro grupo',
  ...
  'plugin.watermark.generate.confirm': 'Tem certeza de que deseja adicionar marca d’água a todas as imagens da biblioteca de imagens?',
  ...
  'plugin.watermark.open.description': 'Quando ativado, marcas d\'água serão adicionadas automaticamente às imagens enviadas.',
  ...
  'plugin.watermark.batch-add': 'Adicione marcas d\'água às imagens da biblioteca de imagens em lotes',
  'plugin.watermark.min-size': 'Imagem mínima de marca d’água',
  'plugin.watermark.min-size.suffix': 'Pixel',
  'plugin.watermark.min-size.description': 'Imagens cujo comprimento e largura sejam menores que esse tamanho não serão adicionadas com marca d’água.',
  ...
  'plugin.weapp.encoding-aes-key.description': 'Se o método de criptografia e descriptografia da mensagem for o modo de texto simples, não preencha este campo, caso contrário, um erro será relatado.',
  'plugin.weapp.default': 'Miniaplicativo padrão',
  'plugin.weapp.default.tips': 'O miniprograma padrão do AnQiCMS também suporta o miniprograma inteligente Baidu, o miniprograma WeChat, o miniprograma QQ, o miniprograma Alipay e o miniprograma Toutiao.',
  'plugin.weapp.default.help': 'Ajuda sobre como usar o miniprograma:',
  'plugin.weapp.default.source': 'Endereço do código-fonte do miniprograma: https://github.com/fesiong/anqicms-app/releases',
  ...
  'plugin.wechat.menu.submit.confirm': 'Tem certeza de que deseja atualizar o menu oficial da conta?',
  'plugin.wechat.menu.submit.content': 'Esta operação sincronizará o menu recém-definido com o servidor WeChat.',
  ...
  'plugin.wechat.menu.value.description': 'Preencha o texto do menu de texto e o endereço URL do menu do link, com no máximo 128 caracteres.',
  'plugin.wechat.menu': 'Menu do WeChat',
  'plugin.wechat.menu.tips': 'Nota: Há um máximo de 3 menus de primeiro nível e um máximo de 5 menus de segundo nível para cada menu de primeiro nível.',
  ...
  'plugin.wechat.reply.default.description': 'Após selecionar como resposta padrão, caso a palavra-chave não corresponda, este conteúdo será respondido',
  ...
  'plugin.wechat.verify-key.description': 'Os usuários podem obter o código de verificação respondendo a esta palavra-chave',
  'plugin.wechat.verify-msg': 'Modelo de informações de código de verificação',
  'plugin.wechat.verify-msg.placeholder': 'Padrão: código de verificação: {code}, válido por 30 minutos',
