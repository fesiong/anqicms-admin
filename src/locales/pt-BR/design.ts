export default {
  ...
  'design.data.tips2':
    'Você pode optar por limpar automaticamente os dados originais do site ao inicializar os dados do modelo.',
  'design.data.tips3':
    'Antes de instalar os dados de demonstração, é recomendável fazer backup dos dados originais do site.',
  ...
  'design.package.zip.tips':
    'Observação: você só pode fazer upload de modelos baixados do meu pacote de detalhes do modelo, ou modelos do mercado de design, ou modelos produzidos localmente. Use o download do meu pacote de detalhes do modelo para criar um pacote compactado.',
  ...
  'design.editor.confirm-giveup':
    'Você tem código não salvo. Tem certeza de que deseja editar um novo arquivo?',
  ...
  'design.editor.tips':
    'Clique com o botão direito na caixa de edição para inserir rapidamente o código da tag do modelo',
  ...
  'design.detail.backup-data':
    'Tem certeza de que deseja adicionar dados de inicialização ao modelo atual?',
  'design.detail.backup-data.tips':
    'Esta operação visa adicionar dados de demonstração para inicialização de modelo ao modelo atual.',
  'design.detail.backup-data.cover.tips':
    'O modelo já contém dados de apresentação e, se executado novamente, os dados de apresentação antigos serão substituídos.',
  ...
  'design.detail.tips2':
    '2. Após o upload da imagem, se o plano de fundo for atualizado, mas o primeiro plano não for atualizado, limpe o cache local do navegador.',
  'design.share.confirm-replace':
    'Tem certeza de que deseja substituir o modelo correspondente ao mercado de modelos?',
  'design.share.confirm-new':
    'Tem certeza de que deseja colocar este modelo no mercado de modelos?',
  ...
  'design.share.only-template.tips':
    'Para modelos já existentes no mercado de modelos, você só pode atualizar o arquivo do modelo.',
  ...
  'design.share.preview.description':
    'Recomenda-se fazer upload de capturas de tela de página inteira do modelo, não menos que 3.',
};
