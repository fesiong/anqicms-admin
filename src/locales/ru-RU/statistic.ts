export default {
  ...
  'statistic.spider-name': 'паук',
  'statistic.http-code': 'код состояния',
  'statistic.user-agent': 'Запросить UA',
  'statistic.traffic.detail': 'Посмотреть подробные записи',
  'statistic.indexing.baidu': 'Байду включен',
