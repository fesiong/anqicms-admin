export default {
  ...
  'plugin.aigenerate.demand.description': 'Dimungkinkan untuk menentukan persyaratan terpadu untuk semua artikel penulisan AI, tidak lebih dari 200 karakter. Biarkan kosong secara default',
  ...
  'plugin.aigenerate.source.description': 'Pernyataan: Hanya situs luar negeri yang dibangun menggunakan Anqi CMS yang dapat memilih untuk menyiapkan OpenAIKey sendiri.',
  'plugin.aigenerate.source.check-openai': 'Periksa antarmuka OpenAI',
  'plugin.aigenerate.openai.description': 'Kunci OpenAI umumnya dimulai dengan sk-, Anda dapat menambahkan beberapa kunci, dan program akan secara acak memilih satu kunci untuk digunakan setiap kali.',
  ...
  'plugin.aigenerate.default-category.description': 'Jika kata kunci tidak diklasifikasikan ke dalam kategori, artikel yang dikumpulkan akan diklasifikasikan secara acak ke dalam salah satu kategori secara default. Anda harus menetapkan kategori, jika tidak, artikel yang dikumpulkan tidak dapat dikumpulkan secara normal.',
  ...
  'plugin.aigenerate.start-time.description': 'Silakan isi angka 0 sampai 23, 0 berarti tidak ada batasnya',
  'plugin.aigenerate.end-time': 'akhir hari',
  'plugin.aigenerate.end-time.placeholder': 'Berakhir pada pukul 22:00 secara default',
  'plugin.aigenerate.end-time.description': 'Silakan isi angka 0 sampai 23, 0 berarti tidak ada batasnya',
  'plugin.aigenerate.daily-limit': 'Rilis harian',
  'plugin.aigenerate.daily-limit.description': 'Jumlah maksimum artikel yang diterbitkan per hari, 0 berarti tidak ada batasan',
  ...
  'plugin.aigenerate.replace.tips1': 'Edit pasangan kata kunci yang perlu diganti, dan penggantian akan otomatis dilakukan saat dokumen diterbitkan.',
  'plugin.aigenerate.replace.tips2': 'Aturan penggantian mendukung ekspresi reguler jika Anda sudah familiar dengan ekspresi reguler dan tidak dapat mencapai persyaratan penggantian melalui teks biasa, Anda dapat mencoba menggunakan aturan ekspresi reguler untuk menyelesaikan penggantian.',
  'plugin.aigenerate.replace.tips3': 'Aturan ekspresi regulernya adalah: dimulai dengan { dan diakhiri dengan }, dan tulis kode aturan di tengahnya, misalnya {[0-9]+} untuk mencocokkan angka yang berurutan.',
  ...
  'plugin.aigenerate.replace.notice': 'Catatan: Penulisan aturan ekspresi reguler yang tidak tepat dapat dengan mudah menyebabkan efek substitusi yang salah. Misalnya, aturan ID WeChat akan memengaruhi integritas alamat email dan URL. Silakan gunakan dengan hati-hati.',
  ...
  'plugin.aigenerate.start.description': 'Ini akan segera mulai menjalankan operasi tugas penulisan AI',
  'plugin.aigenerate.image.category': 'Klasifikasi gambar',
  'plugin.aigenerate.image.category.description': 'Gambar akan dipilih secara otomatis dari kategori sumber daya gambar yang ditentukan. Jika Anda memilih untuk mencoba pencocokan kata kunci dengan nama gambar, ia akan mencoba mencocokkan kata kunci artikel dengan nama gambar, dan jika pencocokan berhasil, gambar tersebut akan digunakan.',
  ...
  'plugin.aigenerate.tips1': 'Penulisan otomatis AI akan memanggil antarmuka penulisan AI untuk menulis, yang memerlukan pembayaran.',
  'plugin.aigenerate.tips2': 'Penulisan otomatis AI akan secara otomatis memanggil kata kunci di perpustakaan kata kunci untuk menyelesaikan penulisan, dan menulis artikel untuk setiap kata kunci. Harap pastikan bahwa jumlah artikel dalam database kata kunci mencukupi.',
  'plugin.aigenerate.tips3': 'Fungsi penulisan otomatis dan pengumpulan artikel AI berbagi perpustakaan kata kunci. Jika kata kunci telah dikumpulkan untuk artikel, kata kunci tersebut tidak lagi digunakan untuk penulisan AI.',
  'plugin.aigenerate.tips4': 'Artikel yang dihasilkan secara otomatis akan masuk ke manajemen konten.',
  ...
  'plugin.anchor.link.description': 'Mendukung tautan relatif dan tautan absolut, seperti: /a/123.html atau https://www.anqicms.com/',
  'plugin.anchor.weight': 'Berat teks jangkar',
  'plugin.anchor.weight.description': 'Silakan masukkan angka, 0-9. Semakin besar angkanya, semakin tinggi bobotnya. Bobot yang lebih tinggi mempunyai prioritas dalam substitusi.',
  'plugin.anchor.import': 'Impor teks jangkar',
  'plugin.anchor.import.description': 'Catatan: Hanya file dalam format csv yang didukung untuk diunggah dan diimpor.',
  ...
  'plugin.anchor.density.description': 'Misal: setiap 100 kata untuk menggantikan teks jangkar, isi 100, defaultnya adalah 100',
  ...
  'plugin.anchor.extract.description': 'Pilih cara mengekstrak kata kunci teks jangkar dari tag kata kunci konten',
  ...
  'plugin.backup.restore.confirm': 'Apakah Anda yakin ingin memulihkan menggunakan cadangan saat ini?',
  'plugin.backup.restore.content': 'Setelah restorasi, data yang ada akan diganti dengan data cadangan saat ini. Silakan lanjutkan dengan hati-hati.',
  ...
  'plugin.backup.cleanup.tips1': 'Operasi ini akan menghapus semua artikel. Demi alasan keamanan, pastikan untuk melakukan pencadangan terlebih dahulu jika terjadi keadaan yang tidak terduga.',
  'plugin.backup.cleanup.tips2': 'Folder Unggahan tidak dibersihkan secara default. Jika Anda perlu membersihkannya, silakan periksa.',
  ...
  'plugin.backup.tips': 'Catatan: Jika file cadangan terlalu besar dan Anda perlu mengunduh file cadangan, silakan gunakan alat FTP untuk mengunduh file cadangan di direktori /data/backup/ dari direktori root situs web.',
  ...
  'plugin.collector.mode.description': 'Mode pengumpulan artikel akan mengumpulkan seluruh artikel sesuai dengan teks asli, mode kombinasi Tanya Jawab akan mengumpulkan dan menggabungkannya menjadi artikel dari daftar Tanya Jawab pencarian.',
  'plugin.collector.source': 'sumber khusus',
  'plugin.collector.source.description': 'Koleksi artikel tersedia, harap diperhatikan bahwa format sumber khusus harus berupa daftar pencarian, dan kata kunci pencarian diwakili oleh %s. Misalnya, tautan pencarian adalah: https://cn.bing.com/search?q= Anqi CMS, lalu " "Anqi CMS" diganti dengan "%s" lalu: https://cn.bing.com/search?q=%s',
  'plugin.collector.category.description': 'Jika tidak ada kategori yang ditetapkan untuk kata kunci tersebut, artikel yang dikumpulkan akan diklasifikasikan dalam kategori ini secara default.',
  'plugin.collector.category.notice': 'Kategori harus ditetapkan, jika tidak, pengumpulan normal tidak akan dapat dilakukan',
  'plugin.collector.min-title': 'Jumlah kata minimum untuk judul',
  'plugin.collector.min-title.placeholder': 'Standarnya 10 karakter',
  'plugin.collector.min-title.description': 'Saat mengumpulkan artikel, jika jumlah kata pada judul kurang dari jumlah kata yang ditentukan, maka tidak akan dikumpulkan.',
  ...
  'plugin.collector.min-content.description': 'Saat mengumpulkan artikel, jika jumlah kata dalam konten artikel kurang dari jumlah kata yang ditentukan, maka tidak akan dikumpulkan.',
  ...
  'plugin.collector.pseudo.description': 'Penulisan ulang AI hanya mendukung pengumpulan artikel dan kombinasi tanya jawab. Diperlukan biaya.',
  ...
  'plugin.collector.translate.description': 'Ada biaya untuk penerjemahan. Catatan: Penulisan ulang dan terjemahan AI tidak dapat diaktifkan secara bersamaan, jika tidak, hasilnya akan salah.',
  ...
  'plugin.collector.daily-limit.description': 'Jumlah maksimal artikel yang dikumpulkan per hari, 0 berarti tidak ada batasan',
  ...
  'plugin.collector.title-exclude.tips': 'Saat mengumpulkan artikel, jika kata kunci tersebut muncul di judul, maka tidak akan dikumpulkan.',
  'plugin.collector.title-prefix': 'Kecualikan kata-kata di awal judul',
  'plugin.collector.title-prefix.tips': 'Saat mengumpulkan artikel, jika kata kunci tersebut muncul di awal judul, maka tidak akan dikumpulkan.',
  'plugin.collector.title-suffix': 'Kecualikan kata-kata di akhir judul',
  'plugin.collector.title-suffix.tips': 'Saat mengumpulkan artikel, jika kata kunci tersebut muncul di akhir judul, maka tidak akan dikumpulkan.',
  'plugin.collector.content-exclude-line': 'baris abaikan konten',
  'plugin.collector.content-exclude-line.tips': 'Saat mengumpulkan artikel, baris di mana kata-kata ini muncul akan dihapus.',
  'plugin.collector.content-exclude': 'Pengecualian konten',
  'plugin.collector.content-exclude.tips': 'Saat mengumpulkan artikel, jika kata-kata ini muncul di konten, seluruh artikel akan dibuang.',
  'plugin.collector.link-exclude': 'Tautan diabaikan',
  'plugin.collector.link-exclude.tips': 'Saat mengumpulkan artikel, jika kata kunci tersebut muncul di tautan, maka artikel tersebut tidak akan dikumpulkan.',
  ...
  'plugin.collector.tips': 'Untuk mengumpulkan artikel, Anda perlu menetapkan kata kunci inti terlebih dahulu. Silakan periksa fungsi "Manajemen Basis Data Kata Kunci" dan tambahkan kata kunci yang sesuai.',
  ...
  'plugin.fileupload.upload.support': 'Catatan: Hanya file verifikasi dalam format txt/htm/html/xml yang boleh diunggah.',
  ...
  'plugin.finance.withdraw.confirm.content': 'Ini setara dengan mengajukan penarikan dari sisi pengguna.',
  ...
  'plugin.finance.withdraw.finish.confirm': 'Apakah Anda yakin ingin menyelesaikan penarikan secara manual?',
  'plugin.finance.withdraw.finish.content': 'Jika Anda telah membayar pengguna secara offline, Anda dapat mengklik di sini untuk menyelesaikannya.',
  ...
  'plugin.fulltext.tips': 'Setelah mengaktifkan pencarian teks lengkap, Anda dapat mencari konten dokumen. Namun, pencarian teks lengkap akan memakan banyak memori server. Jika server Anda memiliki memori kecil, tidak disarankan untuk mengaktifkan pencarian teks lengkap.',
  ...
  'plugin.group.level.description': 'Misal member biasa level 0, anggota perantara level 1, anggota senior level 2, anggota inti level 3, dan seterusnya. Isikan angkanya.',
  'plugin.group.price': 'Harga grup pengguna',
  'plugin.group.price.suffix': 'titik',
  'plugin.group.price.description': 'Harga yang harus dibayar untuk membeli VIP grup pengguna ini. Perhatikan bahwa unitnya adalah sen.',
  'plugin.group.expire_day': 'Masa berlaku grup pengguna',
  'plugin.group.expire_day.suffix': 'langit',
  'plugin.group.expire_day.description': 'Setelah pembelian VIP berlaku berapa hari, silahkan isi 365 untuk 1 tahun.',
  'plugin.group.share_reward': 'Masa berlaku grup pengguna',
  'plugin.group.share_reward.description': 'Disarankan untuk menyetel 5%-20, dan titik desimal tidak dapat disetel. Prioritas rasio komisi: Rasio komisi yang ditetapkan berdasarkan produk > Rasio komisi grup pengguna > Rasio komisi default',
  'plugin.group.parent_reward': 'Rasio hadiah undangan',
  'plugin.group.parent_reward.description': 'Disarankan untuk menyetel 1%-5%, dan titik desimal tidak dapat disetel. Rasio komisi yang unggul. Distributor a mengundang b untuk menjadi distributor, dan b menjadi penjual berikutnya. Bila b berhasil mempromosikan pesanan, b dapat memperoleh komisi distribusi, dan a hanya mendapat hadiah undangan.',
  'plugin.group.discount': 'Diskon pengguna',
  'plugin.group.discount.description': 'Disarankan untuk mengatur 90%-100%. Setelah pengguna membuka halaman melalui link yang dibagikan oleh distributor, mereka dapat menikmati harga diskon saat melakukan pemesanan.',
  ...
  'plugin.guestbook.reply.required': 'Harap atur pengingat email terlebih dahulu dan cari "Pengingat Email" di fungsinya.',
  ...
  'plugin.guestbook.field.delete.confirm.content': 'Anda dapat memulihkan dengan menyegarkan halaman sebelum menyimpan.',
  ...
  'plugin.guestbook.return-message.description': 'Perintah yang dilihat pengguna setelah mengirimkan pesan. Misalnya: Terima kasih atas pesan Anda!',
  ...
  'plugin.htmlcache.generate.all.confirm': 'Apakah Anda yakin ingin membuat cache statis untuk seluruh situs?',
  'plugin.htmlcache.generate.home.confirm': 'Apakah Anda yakin ingin membuat cache statis pada beranda?',
  'plugin.htmlcache.generate.category.confirm': 'Apakah Anda yakin ingin membuat cache statis kolom?',
  'plugin.htmlcache.generate.archive.confirm': 'Apakah Anda yakin ingin membuat cache statis dokumen?',
  'plugin.htmlcache.generate.tag.confirm': 'Apakah Anda yakin ingin membuat cache tag statis?',
  'plugin.htmlcache.clean.confirm': 'Apakah Anda yakin ingin menghapus cache statis seluruh situs? Jika ada banyak file yang di-cache, mungkin memerlukan waktu lama.',
  'plugin.htmlcache.clean.confirm.content': 'Operasi ini hanya membersihkan file cache lokal server dan tidak dapat membersihkan file server statis.',
  'plugin.htmlcache.clean.success': 'Pembersihan berhasil',
  'plugin.htmlcache.push.all.confirm': 'Apakah Anda yakin ingin memasukkan semua file statis ke server statis?',
  'plugin.htmlcache.push.all.confirm.content': 'Ini hanya tersedia ketika server statis dikonfigurasi. Dorongan penuh membutuhkan waktu lama. Jika tidak ada perubahan global yang dilakukan, dorongan tambahan dapat digunakan.',
  'plugin.htmlcache.push.addon.confirm': 'Apakah Anda yakin ingin memasukkan file statis ke server statis secara bertahap?',
  'plugin.htmlcache.push.addon.confirm.content': 'Hanya tersedia ketika server statis dikonfigurasi, dorongan tambahan hanya akan mendorong file cache statis yang diperbarui.',
  ...
  'plugin.htmlcache.tencent.bucket-url.placeholder': 'Misalnya: https://aa-1257021234.cos.ap-guangzhou.myqcloud.com',
  ...
  'plugin.htmlcache.ftp.tips': 'Catatan: Setelah pengujian, PureFtp yang disertakan dengan Pagoda tidak dapat digunakan secara normal.',
  ...
  'plugin.htmlcache.ssh.or-key.description': 'Jika server SSH Anda menggunakan kunci untuk login, silakan unggah',
  ...
  'plugin.htmlcache.description.1': 'Setelah mengaktifkan cache halaman statis, halaman beranda, halaman daftar, dan halaman detail akan di-cache untuk mempercepat pembukaan situs web, namun diperlukan lebih banyak ruang server untuk menyimpan file cache.',
  'plugin.htmlcache.description.2': 'Jika Anda perlu mengaktifkan situs web statis, jenis template harus adaptif. Untuk membuka website statis, Anda perlu mengisi informasi server website statis. Setelah komunikasi berhasil, sistem akan secara otomatis mengirimkan halaman statis ke server website statis.',
  'plugin.htmlcache.description.3': 'Sebelum mengaktifkan situs web statis, Anda perlu mengaktifkan cache halaman statis. Setelah mengaktifkan situs web statis, pencarian, pesan, komentar, 301 jump, dan fungsi lain yang memerlukan data dikirimkan ke backend tidak akan valid, dan situs web hanya akan memiliki efek tampilan.',
  'plugin.htmlcache.description.4': 'Setelah mengaktifkan situs web statis, operasi berikut tidak akan dibuat ulang secara otomatis, dan operasi pembuatan halaman statis perlu dilakukan secara manual: Menyesuaikan templat (memodifikasi templat, mengaktifkan templat), Memodifikasi pengaturan latar belakang (pengaturan global, pengaturan konten, informasi kontak, navigasi , dll.), Modifikasi aturan pseudo-statis dan perubahan lain yang mempengaruhi situasi global',
  ...
  'plugin.importapi.token.confirm.content': 'Setelah pembaruan, Token asli menjadi tidak valid, silakan gunakan alamat API baru untuk pengoperasian.',
  'plugin.importapi.token.copy.success': 'Berhasil disalin',
  'plugin.importapi.tips': 'Konten yang dihasilkan melalui platform pihak ketiga seperti penulisan AI dapat diimpor ke sistem ini melalui API.',
  ...
  'plugin.importapi.field.url-token': 'Alias ​​URL khusus, hanya mendukung angka dan huruf bahasa Inggris',
  'plugin.importapi.field.images': 'Gambar artikel dapat diatur maksimal 9 gambar.',
  'plugin.importapi.field.logo': 'Thumbnail dokumen dapat berupa alamat absolut, seperti: https://www.anqicms.com/logo.png atau alamat relatif, seperti: /logo.png',
  'plugin.importapi.field.publish-time': 'Format: 02-01-2006 15:04:05 Waktu rilis dokumen bisa di kemudian hari, maka dokumen tersebut tidak akan dirilis secara resmi hingga waktunya habis.',
  'plugin.importapi.field.tag': 'Tag Dokumen. Beberapa tag dipisahkan dengan koma bahasa Inggris, misalnya: aaa, bbb, ccc',
  'plugin.importapi.field.diy': 'Bidang khusus lainnya',
  'plugin.importapi.field.diy.remark': 'Jika Anda memasukkan bidang khusus lainnya dan bidang tersebut ada di tabel dokumen, bidang tersebut juga didukung.',
  'plugin.importapi.field.draft': 'Apakah akan menyimpan ke draf. Nilai yang didukung adalah: false|true. Jika benar diisi, dokumen yang diterbitkan akan disimpan ke draf.',
  'plugin.importapi.field.cover': 'Apakah akan menimpa dokumen dengan judul dan ID yang sama ketika ada. Nilai yang didukung adalah: false|true. Jika benar diisi, konten terbaru akan ditimpa. Jika disetel ke salah, kesalahan akan muncul.',
  ...
  'plugin.importapi.category-api.module-id': 'ID model klasifikasi yang ingin diperoleh, isi nomor, nilai yang didukung: 0=semua, 1,2...ID model yang sesuai',
  ...
  'plugin.importapi.train-mopdule.support-version.text': 'Mendukung kolektor lokomotif versi 9.0 atau lebih tinggi untuk mengimpor dan menggunakan modul rilis',
  ...
  'plugin.importapi.token.new.description': 'Token umumnya terdiri dari kombinasi angka dan huruf, lebih panjang dari 10 digit dan kurang dari 128 digit.',
  'plugin.interference.isopen': 'Aktifkan pengumpulan kode anti-interferensi',
  'plugin.interference.isopen.description': 'Pengaturan berikut hanya efektif jika fungsi ini diaktifkan.',
  ...
  'plugin.keyword.batch-import.tips': 'Catatan: Hanya file dalam format csv yang didukung untuk diunggah dan diimpor.',
  ...
  'plugin.keyword.dig-setting.max-count.description': 'Jika perluasan kata otomatis dipilih, jumlah perluasan kata akan valid.',
  ...
  'plugin.keyword.dig-setting.title-exclude.description': 'Saat memperluas kata, jika kata kunci ini muncul di kata kunci, kata kunci tersebut tidak akan dikumpulkan.',
  'plugin.keyword.dig-setting.replace': 'Penggantian kata kunci',
  'plugin.keyword.dig-setting.replace.tips1': 'Edit pasangan kata kunci yang perlu diganti, dan penggantian akan otomatis dilakukan saat kata diperluas.',
  ...
  'plugin.keyword.aigenerate.confirm': 'Apakah Anda yakin ingin melakukan operasi penulisan AI pada kata kunci ini?',
  'plugin.keyword.aigenerate.content': 'Penulisan otomatis AI memerlukan pembayaran, pastikan Anda telah mengikat akun Anqi Anda.',
  ...
  'plugin.keyword.cleanup.content': 'Operasi ini akan menghapus semua kata kunci dan tidak dapat dipulihkan, harap operasikan dengan hati-hati',
  ...
  'plugin.link.field.nofollow': 'Apakah akan menambahkan nofollow, nilai opsional: 0 untuk tidak ditambahkan, 1 untuk ditambahkan',
  'plugin.link.field.back-link': 'Halaman tautan di seberang',
  'plugin.link.field.back-link.description': 'URL halaman tempat pihak lain menempatkan link ke situs ini',
  ...
  'plugin.link.field.contact.description': 'Isi QQ, WeChat, nomor telepon, dll untuk memudahkan kontak tindak lanjut',
  ...
  'plugin.material.import.clear': 'Apakah Anda yakin ingin menghapus materi konten yang telah Anda pilih untuk diunggah?',
  ...
  'plugin.material.import.submit.tips.after': 'Tidak ada bagian yang dipilih untuk materi ini. Apakah Anda ingin melanjutkan pengiriman?',
  ...
  'plugin.material.import.batch-add.tips': 'Catatan: Anda dapat mengunggah artikel yang disimpan dalam bentuk txt atau html.',
  ...
  'plugin.material.import.paste.description': 'Secara default, materi konten akan memfilter semua tag html dan hanya menyimpan teks. Jika Anda perlu menyimpan tag html, silakan periksa',
  ...
  'plugin.order.setting.progress.description': 'Transaksi normal mengharuskan pengguna untuk mengonfirmasi penerimaan atau menyelesaikan pesanan setelah habis masa berlakunya. Transaksi langsung diselesaikan setelah pengguna membayar, dan pesanan selesai.',
  ...
  'plugin.order.apply-refund.confirm': 'Apakah Anda yakin ingin mengajukan pengembalian dana untuk pesanan ini?',
  ...
  'plugin.push.tips': 'Fungsi push mesin pencari mendukung push aktif oleh pencarian Baidu dan pencarian Bing. Meskipun mesin pencari lain tidak memiliki fungsi push aktif, beberapa mesin pencari masih dapat menggunakan JS push.',
  ...
  'plugin.push.baidu.api-link.description': 'Misalnya: http://data.zz.baidu.com/urls?site=https://www.anqicms.com&token=DTHpH8Xn99BrJLBY',
  'plugin.push.bing.api-link.description': 'Misalnya: http://data.zz.baidu.com/urls?site=https://www.anqicms.com&token=DT Misalnya: https://ssl.bing.com/webmaster/api.svc/json /SubmitUrlbatch ?apikey=sampleapikeyEDECC1EA4AE341CC8B6 (perhatikan bahwa APIkey ini diatur dalam pengaturan di sudut kanan atas alat Bing)',
  'plugin.push.google': 'Kunci Akun Google JSON',
  'plugin.push.google.json': 'konten JSON',
  'plugin.push.google.description': 'Tidak tersedia di dalam negeri. Silakan merujuk ke dokumen untuk mendapatkan JSON: https://www.anqicms.com/google-indexing-help.html',
  'plugin.push.other-js': '360/Toutiao dan JS lainnya dikirimkan secara otomatis',
  'plugin.push.other-js.add': 'Tambahkan kode JS',
  'plugin.push.other-js.tips1': 'Anda dapat menempatkan kode JS seperti pengiriman otomatis Baidu JS, penyertaan otomatis 360, dan penyertaan otomatis Toutiao.',
  'plugin.push.other-js.tips2': 'Kode-kode ini perlu dipanggil secara manual di templat. Silakan tambahkan kode `{{- pluginJsCode|safe }}` di akhir templat publik yang akan dipanggil.',
  'plugin.push.other-js.tips3': 'Jendela pop-up seperti pesan/komentar akan secara otomatis memuat kode JS ini.',
  ...
  'plugin.redirect.import.tips': 'Catatan: Hanya file dalam format csv yang didukung untuk diunggah dan diimpor.',
  ...
  'plugin.redirect.from-url.description': 'Ini bisa berupa alamat absolut yang dimulai dengan `http(https)`, atau alamat relatif yang dimulai dengan `/`',
  ...
  'plugin.replace.tips': 'Penggantian seluruh situs adalah operasi lanjutan, dan kesalahan penggantian mungkin terjadi. Disarankan untuk melakukan pencadangan konten sebelum penggantian.',
  ...
  'plugin.retailer.allow-self.description': 'Jika komisi pembelian mandiri diaktifkan, distributor dapat memperoleh komisi terkait jika ia membeli sendiri barang yang didistribusikan. Jika dimatikan, distributor tidak dapat memperoleh komisi jika ia membeli sendiri barang yang didistribusikan. Jika Anda otomatis menjadi distributor, jangan aktifkan komisi pembelian mandiri.',
  ...
  'plugin.retailer.become-retailer.description': 'Jika Anda memilih pemrosesan manual, Anda perlu mengaturnya di manajemen pengguna.',
  'plugin.retailer.cancel.confirm': 'Apakah Anda yakin ingin membatalkan kualifikasi distributor pengguna ini?',
  'plugin.retailer.cancel.content': 'Jika ambang batas distributor adalah otomatis menjadi distributor, maka pembatalannya tidak sah.',
  ...
  'plugin.rewrite.formula5': 'Opsi 5: Mode khusus (mode lanjutan, harap gunakan dengan hati-hati, jika tidak diatur dengan benar, halaman depan tidak akan terbuka)',
  ...
  'plugin.robots.tips.before': 'Robot adalah konfigurasi situs web yang memberi tahu spider mesin pencari halaman mana yang bisa dirayapi dan halaman mana yang tidak bisa dirayapi. Q:',
  'plugin.robots.tips.after': 'Format file robots.txt',
  'plugin.robots.content': 'Konten robot',
  'plugin.robots.content.tips1': '1. Robots.txt dapat memberi tahu Baidu halaman mana di situs web Anda yang dapat dirayapi dan halaman mana yang tidak dapat dirayapi.',
  'plugin.robots.content.tips2': '2. Anda dapat menggunakan alat Robots untuk membuat, memverifikasi, dan memperbarui file robots.txt Anda.',
  ...
  'plugin.sendmail.port.description': 'Port server default adalah 25, port default saat menggunakan protokol SSL adalah 465, dan port default saat menggunakan protokol TLS adalah 587. Silakan tanyakan kepada penyedia layanan email Anda untuk parameter detailnya.',
  'plugin.sendmail.account': 'akun SMTP',
  'plugin.sendmail.account.description': 'Defaultnya adalah akun email, seperti email QQ Anda, seperti 123456@qq.com',
  ...
  'plugin.sendmail.recipient.description': 'Secara default, dikirim ke pengirim. Jika Anda perlu mengirimkannya ke orang lain, silakan isi di sini. Harap gunakan koma untuk memisahkan beberapa penerima.',
  ...
  'plugin.sendmail.auto-reply.description': 'Jika balasan otomatis ke pelanggan diaktifkan, maka ketika pelanggan meninggalkan pesan, maka email balasan otomatis akan otomatis terkirim ke alamat email yang diisi oleh pelanggan.',
  ...
  'plugin.sendmail.send-type.description': 'Setelah dipilih, email akan dikirim dalam skenario yang dipilih.',
  ...
  'plugin.sendmail.tips': 'Pengingat email dapat mengirimkan pesan dari situs web ke kotak surat Anda melalui email.',
  'plugin.sendmail.test.send': 'Kirim email percobaan',
  'plugin.sitemap.tips1': 'Saat ini, semua mesin pencari utama mendukung peta situs dalam format txt saat mengirimkan peta situs, dan ukuran file peta situs txt lebih kecil daripada file peta situs xml. Oleh karena itu, disarankan untuk menggunakan peta situs berformat txt.',
  'plugin.sitemap.tips2': 'Karena pengiriman peta situs setiap mesin pencari dibatasi hingga 50.000 item atau berukuran 10 juta, fungsi peta situs ini akan menghasilkan file peta situs dengan 50.000 item.',
  ...
  'plugin.sitemap.exculde-module.description': 'Jika Anda ingin mengecualikan model dokumen tertentu, Anda dapat memilihnya di sini',
  'plugin.sitemap.exculde-category': 'Kategori yang dikecualikan',
  'plugin.sitemap.exculde-category.description': 'Jika Anda ingin mengecualikan kategori tertentu, Anda dapat memilih di sini',
  'plugin.sitemap.exculde-page': 'Satu halaman tidak termasuk',
  'plugin.sitemap.exculde-page.description': 'Jika Anda ingin mengecualikan satu halaman tertentu, Anda dapat memilih di sini',
  'plugin.sitemap.action': 'operasi manual',
  'plugin.sitemap.action.tips': 'Tip: Setelah memodifikasi konfigurasi Peta Situs, harap buat Peta Situs secara manual agar konfigurasi dapat diterapkan.',
  ...
  'plugin.storage.tips': 'Mengganti metode penyimpanan sumber daya tidak akan secara otomatis menyinkronkan sumber daya yang diunggah sebelumnya. Umumnya tidak disarankan untuk mengganti metode penyimpanan saat digunakan.',
  ...
  'plugin.storage.keep-local.description': 'Saat menggunakan penyimpanan cloud, Anda dapat memilih untuk menyimpan arsip lokal',
  ...
  'plugin.timefactor.republish.description': 'Saat memperbarui dokumen, kirimkan ulang untuk mencoba mesin pencari.',
  'plugin.timefactor.release-draft': 'Apakah akan mengaktifkan penerbitan otomatis dokumen kotak draf',
  ...
  'plugin.timefactor.daily-limit.description': 'Setelah pengaturan, terbitkan sejumlah artikel tertentu dari kotak draf setiap hari, defaultnya adalah 100',
  ...
  'plugin.timefactor.category.placeholder': 'Jika Anda ingin mengecualikan kategori tertentu, Anda dapat memilih di sini',
  ...
  'plugin.titleimage.open.description': 'Jika diaktifkan, ketika dokumen tidak mempunyai gambar, gambar yang berisi judul dokumen akan secara otomatis dibuat sebagai gambar thumbnail dokumen.',
  'plugin.titleimage.draw-sub': 'Apakah akan menghasilkan gambar judul sekunder untuk dokumen tersebut',
  'plugin.titleimage.draw-sub.description': 'Setelah diaktifkan, ketika dokumen tidak memiliki gambar, gambar akan secara otomatis dibuat untuk tag h2 dokumen dan dimasukkan ke dalam dokumen.',
  'plugin.titleimage.size': 'Hasilkan ukuran gambar',
  'plugin.titleimage.width': 'Lebar piksel',
  'plugin.titleimage.width.placeholder': 'Apakah akan menghasilkan teks dengan default 800 judul dan gambar sekunder',
  ...
  'plugin.titleimage.bg-image.description': 'Anda dapat menyesuaikan latar belakang. Jika Anda tidak mengunggah latar belakang khusus, sistem akan secara otomatis menghasilkan latar belakang warna solid.',
  ...
  'plugin.transfer.token.required': 'Silakan isi Token komunikasi yang bisa berupa karakter apa saja',
  ...
  'plugin.transfer.tips': 'Saat ini, konten situs web DedeCMS / WordPress / PbootCMS / EmpireCMS didukung untuk dimigrasikan ke anqicms.',
  ...
  'plugin.transfer.step2.tips': 'Silakan unggah file yang diunduh ke direktori root situs web Anda. Setelah mengunduh dan menempatkannya di direktori root situs web Anda, klik Berikutnya untuk melanjutkan.',
  'plugin.transfer.step3.tips': 'Hanya satu Token yang dapat dikonfigurasi untuk setiap situs web. Jika Anda menerima pesan kesalahan, harap hapus secara manual anqicms.config.php di direktori root situs web untuk mengonfigurasinya kembali.',
  ...
  'plugin.user.password.description': 'Jika Anda perlu mengubah kata sandi untuk pengguna ini, silakan isi di sini, minimal 6 karakter',
  ...
  'plugin.user.expire.description': 'Setelah habis masa berlakunya, grup pengguna akan kembali ke grup pertama',
  ...
  'plugin.watermark.generate.confirm': 'Apakah Anda yakin ingin menambahkan tanda air ke semua gambar di perpustakaan gambar?',
  'plugin.watermark.generate.content': 'Gambar yang sudah diberi watermark tidak akan ditambahkan lagi.',
  ...
  'plugin.watermark.open.description': 'Jika diaktifkan, tanda air akan otomatis ditambahkan ke gambar yang diunggah.',
  ...
  'plugin.watermark.batch-add': 'Tambahkan tanda air ke gambar di perpustakaan gambar secara bertahap',
  'plugin.watermark.min-size': 'Gambar tanda air minimal',
  'plugin.watermark.min-size.suffix': 'Piksel',
  'plugin.watermark.min-size.description': 'Gambar yang panjang dan lebarnya lebih kecil dari ukuran ini tidak akan ditambahkan tanda air.',
  ...
  'plugin.weapp.encoding-aes-key.description': 'Jika metode enkripsi dan dekripsi pesan adalah mode teks biasa, mohon jangan mengisi kolom ini, jika tidak, kesalahan akan dilaporkan.',
  'plugin.weapp.default': 'Applet bawaan',
  'plugin.weapp.default.tips': 'Program mini default AnQiCMS juga mendukung program mini pintar Baidu, program mini WeChat, program mini QQ, program mini Alipay, dan program mini Toutiao.',
  'plugin.weapp.default.help': 'Bantuan dalam menggunakan program mini:',
  'plugin.weapp.default.source': 'Alamat kode sumber program mini: https://github.com/fesiong/anqicms-app/releases',
  ...
  'plugin.wechat.menu.submit.content': 'Operasi ini akan menyinkronkan menu yang baru diatur ke server WeChat.',
  ...
  'plugin.wechat.menu.value.description': 'Silahkan isi teks untuk menu teks dan alamat url untuk menu link, maksimal 128 karakter.',
  'plugin.wechat.menu': 'Menu WeChat',
  'plugin.wechat.menu.tips': 'Catatan: Terdapat maksimal 3 menu tingkat pertama, dan maksimal 5 menu tingkat kedua untuk setiap menu tingkat pertama.',
  ...
  'plugin.wechat.reply.default.description': 'Setelah dipilih sebagai balasan default, jika kata kunci tidak cocok, konten ini akan dibalas',
  ...
  'plugin.wechat.verify-key.description': 'Pengguna bisa mendapatkan kode verifikasi dengan membalas kata kunci ini',
