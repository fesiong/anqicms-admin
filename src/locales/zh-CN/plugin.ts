export default {
  ...
  'plugin.backup.remark': '备注',
  'plugin.backup.remark.edit': '备注',
  'plugin.backup.remark.title': '设置备份备注',
  'plugin.backup.remark.placeholder': '请输入备注内容，便于识别该备份的用途',
  ...
  'plugin.replace.backup-before': '替换前先备份',
  'plugin.replace.backup-before.tips':
    '已开启替换前备份，将先执行全站备份（含模板），完成后再执行替换。',
  'plugin.replace.backuping': '正在执行替换前备份，请稍候...',
  'plugin.replace.backup.failed': '备份失败，已取消替换操作',
  ...
  'plugin.replace.place.nav': '导航菜单',
  'plugin.replace.place.link': '友情链接',
  'plugin.replace.place.redirect': '跳转链接',
  'plugin.replace.place.place': '地区/位置',
  'plugin.replace.place.guestbook': '留言板',
  'plugin.replace.place.template': '模板文件',
  ...
  'plugin.akismet.setting': 'Akismet/reCAPTCHA 垃圾留言/评论检测设置',
