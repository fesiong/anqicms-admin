              ...
              fieldProps={{
                value:
                  setting.last_update > 0
                    ? dayjs(setting.last_update * 1000).format('YYYY-MM-DD HH:mm')
            ...
            <ProForm onFinish={onSubmitUpdate} initialValues={setting}>
              <ProFormRadio.Group
                ...
                options={[
                  {
                    value: '',
                    label: intl.formatMessage({ id: 'tool.cache.cache-type.auto' }),
                  },
                  {
                    value: 'file',
                    label: intl.formatMessage({ id: 'tool.cache.cache-type.file' }),
                  },
                  {
                    value: 'memory',
                    label: intl.formatMessage({ id: 'tool.cache.cache-type.memory' }),
                  },
                ]}
                extra={intl.formatMessage({ id: 'tool.cache.cache-type.description' })}
              />
            </ProForm>
          )}
        </Card>
      ...
      <div className="mt-normal">
        <Card title={intl.formatMessage({ id: 'tool.cache.table-upgrade' })}>
          <ProForm submitter={false}>
            <Alert
              className="mb-normal"
              message={intl.formatMessage({ id: 'tool.cache.table-upgrade.description' })}
            />
            <ProFormText>
