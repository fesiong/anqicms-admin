export default {
  ...
  'tool.cache.cache-type.description': '默认自动处理，服务器内存小于等于1G的采用文件缓存，大于1G的采用内存缓存',
  'tool.cache.table-upgrade': '更新数据库表结构',
  'tool.cache.table-upgrade.description': '如果你发现缺少某个表或表字段不正确的时候，则可能需要点击下方的更新数据库表结构按钮来更正',
};
